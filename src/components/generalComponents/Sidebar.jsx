...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed z-10 ${display ? "translate-x-0" : "-translate-x-[500px]"} flex min-h-screen w-[279px] flex-col items-center justify-between bg-[#203F41] py-[32px] text-[#F5F6F6] duration-300 xl:static xl:translate-x-0`}
    >
      <div>
